	...
	<div class="container" height=100%>
	  <form class="form-horizontal" role="form" action="<?php echo 'http://localhost/answers/index.php/login/login'; ?>" method="post">
		<div class="form-group">
		  <label class="control-label col-sm-2" for="username">Username Please la:</label>
		  <div class="col-sm-10">
			<input type="username" class="form-control" id="username" name="username" placeholder="Enter username">
		  </div>
		</div>
		<div class="form-group">
		  <label class="control-label col-sm-2" for="pwd">Password Please la:</label>
		  <div class="col-sm-10">          
		...
		<div class="form-group">        
		  <div class="col-sm-offset-2 col-sm-10">
			<button type="submit" class="btn btn-default" style="border-radius: 50%;">Login</button>
		  </div>
		</div>
	  </form>
